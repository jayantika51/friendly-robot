...
class parent():
    ...
    def softwareEngineer(it_professional_name):
        ...
        Label["text"]= it_professional_name+" has been alloted to "+IT_company_list[random_IT_company]
    ...
    def chemicalEngineer()                           :
        ...
        company_list=["CDM Smith","Emerson","Paradise Placement Consultancy","Tetra Pak"]
